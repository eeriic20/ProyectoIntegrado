...
/**
 * <h1>Menu Ginos-Proyecto Integrado.</h1>
 * 
...
public class MenuGinos extends JFrame {
	...
	public MenuGinos(String nombreuser, int id, String localidad, String direccionD, String empresaE) {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(MenuGinos.class.getResource("/vista/Imagenes/logofinal.png")));
		...
		/**
		 * Loss siguentes botones realizan los pedidos
		 */
		...
		/**
		 * Este boton retrocede a la pantalla de seleccion de restaurantes
		 */
		...
		/**
		 * Este boton finaliza el pedido y lo sube a la DB
		 */
		...
		/**
		 * Este boton permite ver el pedido
		 */
